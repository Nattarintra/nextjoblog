`../../supabase-test/supabase/migrations/` holds a manual copy of this directory, used by the
...
changed here, copy the same change to `../../supabase-test/supabase/migrations/`.
